...
import yala1 from "../images/yala1.jpg";
    ...
    <div style={styles.container}>
      ...
      <div style={styles.mainContent}>
        <section style={styles.description}>
          <h2 style={styles.sectionTitle}>Yala Tour</h2>
          <img
            src={yala2}
            alt="Colombo"
            style={{
          ...
          <div style={styles.section}>
            ...
            Embark on an exhilarating adventure to Yala National Park, one of Sri Lanka’s premier wildlife sanctuaries. Renowned for its dense population of leopards, Yala offers a thrilling safari experience as you traverse through its diverse landscapes of lush jungles, grasslands, and lagoons.

Spot majestic elephants, sloth bears, spotted deer, and a variety of exotic birds in their natural habitats. The park is also home to crocodiles basking by the water and other fascinating reptiles. With a bit of luck, you might even catch a glimpse of the elusive leopards, making this safari an unforgettable highlight.

Immerse yourself in the raw beauty of nature and experience a unique connection with Sri Lanka's rich biodiversity on this unforgettable day trip.
